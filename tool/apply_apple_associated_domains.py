...
# The legal-localization patch rewrites the legalPage(...) call later in the
# recipe. On a second npm lifecycle pass (precheck -> prestart), the AASA route
# is already present even though the original insertion anchor no longer is.
# Treat the existing route as the idempotency marker.
