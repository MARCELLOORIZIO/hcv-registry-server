...
// Dart preserves the distinction between an integer and a double whose value is
// mathematically integral. JavaScript JSON.parse/JSON.stringify does not: 1.0
// becomes 1. The production verifier must therefore recover the exact lexical
// JSON representation that the app signed.
